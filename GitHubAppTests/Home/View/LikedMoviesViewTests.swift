...
final class LikedMoviesViewTests: XCTestCase {
    ...
    func testNavigationDestinationConfiguration() {
        ...
        XCTAssertEqual(testViewModel.likedMovies.count, 1)
    }
    ...
    func testScrollIndicatorsHiddenConfiguration() {
        ...
        // Verify that the view is properly configured
        XCTAssertNotNil(testView)
        XCTAssertEqual(testViewModel.likedMovies.count, 2)
    }
    ...
    func testPreviewConfiguration() {
        ...
        let previewView = LikedMoviesView(viewModel: LikedMoviesViewModel())
    ...
    func testEmptyStateTextElements() {
        ...
        XCTAssertTrue(vm.likedMovies.isEmpty)
    }
    ...
    func testMovieListButtonConfiguration() {
        ...
        XCTAssertNotNil(host.view)
        XCTAssertEqual(vm.likedMovies.count, 1)
    }
    ...
    func testLikeButtonConfiguration() {
        ...
        _ = view.wrappedViewController
        XCTAssertNotNil(view)
        XCTAssertTrue(vm.isLiked(movie: vm.likedMovies[0]))
    }
    ...
    func testMovieTitleAndOverviewDisplay() {
        ...
        _ = view.wrappedViewController
        XCTAssertNotNil(view)
        XCTAssertEqual(vm.likedMovies[0].title, "Test Movie")
        XCTAssertEqual(vm.likedMovies[0].overview, "Test Overview")
    }
    ...
    func testListConfigurationWithMultipleMovies() {
        ...
        _ = view.wrappedViewController
        XCTAssertNotNil(view)
        XCTAssertEqual(vm.likedMovies.count, 3)
    }
...
/**
 * Mock ViewModel for testing LikedMoviesView behavior.
 *
 * This mock allows us to track when specific methods are called
 * and verify the behavior of the view.
 */
private class MockLikedMoviesViewModel: ObservableObject {
